...
public class UnitMeasureRepositoryIT {
    ...
    public void findByDescription() throws Exception {
        ...
        Optional<UnitMeasure> umOptional = unitMeasureRepository.findByDescription("Teaspoon");
    ...
    public void findByDescriptionCup() throws Exception {
        ...
        Optional<UnitMeasure> umOptional = unitMeasureRepository.findByDescription("Cup");
